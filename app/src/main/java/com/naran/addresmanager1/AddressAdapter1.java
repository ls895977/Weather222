...
public class AddressAdapter1 extends
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            btnDelete = (TextView) v.findViewById(R.id.delete);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder,
        ...
        if (position != this.getItemCount()) {
            ...
            ((ViewHolder) holder).btnDelete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AddressChangeTask.getInstance().fireMsg(1,textArticleTitles.get(position));
                }
            });
